...
void Device::pickPhysicalDevice(VkInstance& instance, const VkSurfaceKHR& surface)
{
...
void Device::createLogicalDevice(const std::vector<const char*>& validationLayers, const VkSurfaceKHR& surface)
{
